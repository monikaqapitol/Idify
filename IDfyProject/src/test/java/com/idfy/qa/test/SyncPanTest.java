...
public class SyncPanTest {
	...
	public void testPanOcr(APIPostRequest request, APIPostPanResponse expectedResponse) throws IOException {
		...
		try {
			if(response.getResult().getPanNumber()!=null) {
		...
		try {
			if(response.getResult().getNameOnCard()!=null) {
				exList.add("name_on_card");
			}}catch(NullPointerException e) {
				
		}
		try {
			if(response.getResult().getDateOnCard()!=null) {
				exList.add("date_on_card");
			}}catch(NullPointerException e) {
				
		}
		try {
			if(response.getResult().getAge()!=null) {
				exList.add("age");
			}}catch(NullPointerException e) {
		...
		try {
			if(response.getResult().isIscanned()==(true||false)) {
				exList.add("is_scanned");
			}}catch(NullPointerException e) {
				
			}
		try {
			if(response.getResult().isMinor()==(true||false)) {
				exList.add("minor");
			}}catch(NullPointerException e) {
		...
		try {
			if(response.getResult().getPanType()!=null) {
				exList.add("pan_type");
			}}catch(NullPointerException e) {
		...
		try {
			if(response.getResult().getFathersName()!=null) {
		...
		try {
			if(response.getResult().getRawtext()!=null) {
				exList.add("raw_text");
			}}catch(NullPointerException e) {
